...
enWinner WhoWonTheRound(stRoundInfo RoundInfo)
{
    ...
    //if you reach here than Player 1 is the winnwe
...
{
    cout << Tabs(2) << "____________________[Game Results]_________________________\n\n" << endl;
...
void StartGame()
{
    ...
    {
        ResetGame();
        stGameResults GameResults = PlayGame(ReadHowManyRounds()); // Play 3 rounds.
        ShowGameOverScreen();
